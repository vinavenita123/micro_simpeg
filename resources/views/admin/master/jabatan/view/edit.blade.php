                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                        id="edit_id_unit" data-allow-clear="true" data-placeholder="Unit" required>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="edit_jabatan" class="form-control form-control-sm fs-sm-8 fs-lg-6"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                        id="edit_id_eselon" data-allow-clear="true" data-placeholder="Eselon" required>
                                </select>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                        id="edit_id_periode" data-allow-clear="true" data-placeholder="Periode" required>
                                </select>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
