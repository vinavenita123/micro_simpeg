        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex flex-column mb-2">
                    ...
                    <p class="fw-light fs-sm-8 fs-lg-6" id="detail_periode"></p>
                </div>
                <div class="d-flex flex-column mb-2">
                    <label class="d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1">
                        <span>Tanggal Aktif</span>
                    </label>
                    <p class="fw-light fs-sm-8 fs-lg-6" id="detail_tanggal_aktif"></p>
                </div>
                <div class="d-flex flex-column mb-2">
                    <label class="d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1">
                        <span>Tanggal Non Aktif</span>
                    </label>
                    <p class="fw-light fs-sm-8 fs-lg-6" id="detail_tanggal_akhir"></p>
                </div>
                <div class="d-flex flex-column mb-2">
                    <label class="d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1">
                        <span>Status</span>
