                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="periode" class="form-control form-control-sm fs-sm-8 fs-lg-6"
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="tanggal_awal" class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                       required>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="tanggal_akhir" class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                       required>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                        id="status" data-allow-clear="true" data-placeholder="Status" required>
